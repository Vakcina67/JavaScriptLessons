// возможно, неправильно понял задание, т.к. код получился явно неоптимальным.
// проще задать массив, в case проверяем находится ли переменная а в массиве
// и далее через цикл вывести значения на экран.
let a = 4;
